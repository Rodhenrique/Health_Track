...
public class PressaoArterial implements ICrud<PressaoArterial> {
    // Lista de clientes para simular o armazenamento de dados
    private List<PressaoArterial> pressaoArterials = new ArrayList<PressaoArterial>();
    ...
    public PressaoArterial(int idPressaoArterial,int sistolica, int diastolica, float bpm, int idCliente, LocalDateTime dataCriacao, LocalDateTime dataAlteracao) {
    ...
    public List<PressaoArterial> ListarPorIdCliente(int idCliente) {
